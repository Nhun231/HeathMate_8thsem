...
import { createDietPlan, getCurrentDietPlan } from "../../services/DietPlan";
    ...
    <Container maxWidth="md" sx={{ mt: 8 }}>
      ...
      >
        ...
        <Typography align="center" mb={4} sx={{ color: "#666" }}>
          Hãy chọn mục tiêu và cân nặng mong muốn để SmartDiet gợi ý kế hoạch
          phù hợp!
        </Typography>
        ...
        <Box display="flex" flexDirection="column" gap={3}>
          ...
          >
            ...
            <MenuItem value="MaintainWeight">Giữ nguyên cân nặng</MenuItem>
          ...
          <Button
            ...
            disabled={!goal || (goal !== "MaintainWeight" && !weightChange)}
          >
            {hasDietPlan ? 'Cập nhật kế hoạch' : 'Tạo kế hoạch'}
          </Button>
        </Box>
