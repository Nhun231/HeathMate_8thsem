    ...
    <Box sx={{ minHeight: "100vh", backgroundColor: "#f5f5f5" }}>
      <Container maxWidth="xl" sx={{ py: 4 }}>
        ...
        <Grid container spacing={3} sx={{ mb: 4 }}>
          ...
          <Grid item xs={12} sm={6} md={3}>
            <Card
              sx={{ backgroundColor: "#E3F2FD", border: "2px solid #2196F3" }}
            >
              <CardContent>
                <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
                  <AccountBalance
          ...
          <Grid item xs={12} sm={6} md={3}>
            <Card
              sx={{ backgroundColor: "#FFF3E0", border: "2px solid #FF9800" }}
            >
              <CardContent>
                <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
          ...
          <Grid item xs={12} sm={6} md={3}>
            <Card
              sx={{ backgroundColor: "#F3E5F5", border: "2px solid #9C27B0" }}
            >
              <CardContent>
                <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
        ...
        <Paper sx={{ width: "100%" }}>
          ...
          <Box sx={{ p: 3 }}>{tabContent[activeTab].component}</Box>
        </Paper>
      </Container>
    </Box>
  );
